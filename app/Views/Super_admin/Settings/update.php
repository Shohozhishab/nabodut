                        ...
                        <div class="row">
                            ...
                            <div class="tab-content " style="margin-top: 60px;">
                                <div role="tabpanel" class="tab-pane <?php echo (!empty($_GET) && ($_GET['active'] == 'general'))?'active':'';?> <?php echo(empty($_GET))?'active':'';?>" id="home">
                                    <div class="col-lg-6 ">
                                        <form action="<?php echo base_url('Super_admin/Settings/general_update'); ?>" method="post">
                                            ...
                                            <a href="<?php echo site_url('Super_admin/Settings') ?>" class="btn btn-default">Cancel</a>
                                ...
                                <div role="tabpanel" class="tab-pane <?php echo (!empty($_GET) && ($_GET['active'] == 'personal'))?'active':'';?>" id="profile">
                                    <div class="col-lg-6">
                                        <form action="<?php echo base_url('Super_admin/Settings/personal_update'); ?>" method="post">
                                ...
                                <div role="tabpanel" class="tab-pane <?php echo(!empty($_GET) && ($_GET['active'] == 'photo'))?'active':'';?>" id="messages">
                                    <div class="col-lg-6">
                                        <form action="<?php echo base_url('Super_admin/Settings/photo_update'); ?>" method="post" enctype="multipart/form-data" >
