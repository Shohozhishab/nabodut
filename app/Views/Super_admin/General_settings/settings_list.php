                ...
                <div class="box">
                    <div class="box-header">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
<!--                                 <a href="--><?php //echo base_url('Super_admin/General_settings/create')?><!--" class="btn btn-block btn-primary">Add</a>-->
                            </div>
                            ...
                            <?php $i=1; foreach ($settings as $val){ ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url('Super_admin/General_settings/update/'.$val->settings_id_sup)?>" class="btn btn-warning btn-xs">Update</a>
                                    </td>
                                </tr>
                            <?php }?>
