<div class="content-wrapper" id="viewpage">
    ...
    <section class="content-header">
        <h1> Vat balance update  <small>Vat balance update</small></h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Vat balance update</li>
        </ol>
    </section>
            ...
            <div class="col-lg-12" style="margin-top: 15px;">
                ...
                <div class="box">
                    <div class="box-header">
                        <div class="row">
                            <div class="col-lg-9">
                                <h3 class="box-title">Vat balance update</h3>
                            </div>
                            <div class="col-lg-3">
                            </div>
                    ...
                    <div class="box-body" >
                        ...
                        <div class="col-md-4">
                            <form id="geniusform2" method="POST" action="<?php echo site_url('Admin/Closing/ledger_vat_action');?>">
