<div class="content-wrapper" id="viewpage">
    ...
    <section class="content-header">
        <h1> Salary Receipt <small>Salary Receipt</small></h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Salary Receipt</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-sm-12 " style="padding: 10px; border:1px dashed #D0D3D8;">
                <div class="col-sm-12" style="padding: 10px;">
                    <b>Received Whith thanks from :</b> <span style=" border-bottom:2px dashed #D0D3D8; "> <?php $employeId = get_data_by_id('employee_id','transaction','trans_id',$transactionId); echo get_data_by_id('name','employee','employee_id',$employeId);?></span>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-8" style="padding: 10px;">
                <table class="table">
                    ...
                    <tr>
                        <td><b>Amount In Word:</b>  <span style=" border-bottom:2px dashed #D0D3D8; "><?php $amount = get_data_by_id('amount','transaction','trans_id',$transactionId); echo numberTowords($amount);?> Tk.</span></td>
                    </tr>
